...
<https://github.com/canonical/sphinx-stack/releases/tag/1.5>`__ is available
on GitHub.
...
For docs based on starter pack 1.3 or higher, we published :ref:`update-new-sphinx-stack`.
...
<https://github.com/canonical/sphinx-stack/blob/main/CONTRIBUTING.md>`__.
