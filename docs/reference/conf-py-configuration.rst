.. meta::
   :description: A reference of the default configuration included in the Sphinx Stack.
...
.. list-table::
   ...
   * - ``sitemap_excludes``
     - Lists the non-public pages to be excluded from the sitemap. 
       ...
       Wildcards are supported. For details, see `Excluding Pages <https://sphinx-sitemap.readthedocs.io/en/latest/advanced-configuration.html#excluding-pages>`_.
